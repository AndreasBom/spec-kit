...
```bash
uv tool install specify-cli --from git+https://github.com/AndreasBom/spec-kit.git
```
...
```bash
uv tool install specify-cli --force --from git+https://github.com/AndreasBom/spec-kit.git
```
